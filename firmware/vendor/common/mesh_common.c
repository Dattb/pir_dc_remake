...
//	}
	...
	//0001 210201 0002 (V1 AC)
	tbl_scanRsp.rsv_user[0]=0;
	tbl_scanRsp.rsv_user[1]=0;
	tbl_scanRsp.rsv_user[2]=0;



	tbl_scanRsp.rsv_user[3]=0x00;
	tbl_scanRsp.rsv_user[4]=0x01;
	tbl_scanRsp.rsv_user[5]=0x21;
	tbl_scanRsp.rsv_user[6]=0x02;
	tbl_scanRsp.rsv_user[7]=0x01;

	tbl_scanRsp.rsv_user[8]=0x00;
	tbl_scanRsp.rsv_user[9]=0x03;

	tbl_scanRsp.rsv_user[10]=0x00;
	#if(RD_TYPE_SENSOR == RD_SENSOR_PIR_LIGHT)
