...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
    ...
    {RD_OPCODE_TYPE_DEVICE_SEND,0,VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S,RD_Messenger_Process_Type_Device,RD_OPCODE_TYPE_DEVICE_SEND},
    {RD_OPCODE_TYPE_DEVICE_RSP,1,VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S,end_config,RD_OPCODE_TYPE_DEVICE_RSP},
    {RD_OPODE_SEND_DATA,0,VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S,RD_Messenger_Process_Null_1,RD_OPODE_SEND_DATA},
#endif
