...
boot/8258/%.o: ../boot/8258/%.S
	...
	tc32-elf-gcc -Xassembler"E:\D\Rang_Dong_tren_cty\CODE_Telink_BLE\pir_DC_new\firmware" -DMCU_STARTUP_8258_RET_16K -D__PROJECT_MESH__=1 -DCHIP_TYPE=CHIP_TYPE_8258 -c -o"$@" "$<"
