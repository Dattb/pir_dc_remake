...
#define PIR_FLAG_SAVE_REG					DEEP_ANA_REG6		// thoi gian giu co
#define PIR_TIMEOUT_REG0					DEEP_ANA_REG7		// pirHighFlag + pirLowFlag + motionFlag
#define PIR_TIMEOUT_REG1					DEEP_ANA_REG8		// pirHighFlag + pirLowFlag + motionFlag

//lux flag chua dung
#define MOTION_TIME							DEEP_ANA_REG0

#define POLL_TIME							DEEP_ANA_REG1

#define lUX_SAVE_REG0						DEEP_ANA_REG9
#define lUX_SAVE_REG1						DEEP_ANA_REG10
